...
export default {
  ...
  'baneos.segun': 'por tasa de ban en {rango}',
  ...
  'pie.rangoFuerza': 'Rango: {rango} · winrates de {usado} (la hoja «Meta» dice por qué) · ventana {dias} días',
  ...
  'peligro.fuerte': 'gana el {pct}% en {rango}',
